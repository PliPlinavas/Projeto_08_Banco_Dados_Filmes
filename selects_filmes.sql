...
SELECT * FROM filmes WHERE genero in ("terror","drama") AND ano_lancamento <= 2002
...
SELECT * FROM filmes WHERE diretor in ("Quentin Tarantino")
-- 13. Eu quero saber quais os filmes do James Cameron e quais os generos deles
SELECT * FROM filmes WHERE diretor in ("James Cameron","genero")
...
('bastardos inglorius', 'Drama', 2009, 153, 'Quentin Tarantino', 8.3)
-- 15. Vamos adiconar as informações do filme que o professor odeia.
INSERT INTO filmes (titulo, genero, ano_lancamento, duracao_minutos, diretor, nota_imdb) VALUES
('Homem aranha longe de casa ','ação', 2019 , 210, 'Jon Watts',7.3 )
